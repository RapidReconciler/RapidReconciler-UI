...
.PARAMETER Company
  JDE company number on the rcardexledgercompare2 row (e.g. '90900').
...
.EXAMPLE
  .\transaction-detail-workflow.ps1 -Company 90900 -Doc 900605 -DocType IM
...
try {
  ...
  # returns account values like "9800100.142000" (string nchar) but
