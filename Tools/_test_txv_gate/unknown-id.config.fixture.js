 ...
 * Identical to valid.config.fixture.js except TXI's second checked entry cites
 * TXI.nosuchthing, an id no @asserts line declares. Exactly one violation.
 */
    ...
    'TXI': {
      ...
      finding: {
        ...
        checked: [
          ...
          { a: 'TXI.nosuchthing', t: 'Both legs present. Missing leg ruled out.' }
        ]
      }
    },
    'CNJ': {
