/* ============================================================
   Demo2 env/reload-job VERIFY — run AFTER env_ops.sql (or after a VALC
   ...
   Turns "did we miss an env update?" into a loud PASS/FAIL checklist —
   this is the fix for the Demo1 silent miss. Change the :setvars for TR.
   REFENV = a known-good env to diff variable completeness against.
   ============================================================ */
...
/* 4. critical connection vars non-blank (JdeUserName is the one Build blanked in Demo1) */
...
/* 6. reload job renamed + step-1 @env + step-2 db (the pieces the runbook omitted) */
