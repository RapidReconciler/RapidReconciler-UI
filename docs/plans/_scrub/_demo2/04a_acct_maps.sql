...
INSERT scrub.map_sub (old_sub, new_sub) SELECT s, 'SB' + RIGHT('00000'+CAST(rn AS varchar(10)),5) FROM r;  /* Demo2: widened 2->5 digits for real-customer sub cardinality */
