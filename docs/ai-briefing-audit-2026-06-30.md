...
Two companies every period: **90900 (USD)**, **90050 (GBP)**. Latest/open period =
...
|---|---|---|---|---|
| 2015-10-31 | 90050 GBP | -47.68 | Manual entries (-2,995 vs +2,947) | trivial |
| 2015-11-28 | 90900 USD | -29,245.59 | Manual entries (-68,172 vs +38,926) | rolls fwd, cleared Dec |
| 2016-02-27 | 90050 GBP | 2,310.03 | Transactions (+2,310) | rolls into Apr 2 |
| 2016-04-02 | 90050 GBP | 9,163.95 | Transactions (+6,854; carry +2,310) | the screenshot |
| 2016-04-02 | 90900 USD | -739.73 | Manual entries (-151,866 vs +151,127) | residual of offset |
| 2016-04-30 | 90900 USD | -101.16 | Transactions (+75,339 vs -74,701) | trivial residual |
| 2016-07-02 | 90050 GBP | -93.87 | Manual entries (-748 vs +654) | trivial |
| 2016-07-30 | 90050 GBP | -18,674.74 | Manual entries (-18,843) | rolls into open period |
| 2016-08-27 | 90050 GBP | -18,521.83 | **Carry forward (-18,675)** | **open — traces to Jul 30 JE** |
| 2016-08-27 | 90900 USD | -3,881.41 | Manual entries (-3,448) | open |

**Key structural truth the AI mostly misses:** Co 90900 reconciles to **$0.04**
...
- **Speculative "missing journal entry."** The AI says *"the Accountant likely
  ...
  (Apr 2 Co 90050) or where the net is a tiny residual of two offsetting $150K legs.
...
"this is worth it" moment is a **trend read**, e.g. *"Co 90050 has carried an
...
3. **Prompt tightened for concision + no double attribution + no closed-period
   ...
   Example (Apr 30 historical): *before* a 60-word point → *after* "Co 90900 carry
...
one-line **trend** ("Co 90050 has carried an unoffset balance forward 2 periods,
...
- *Before:* verdict adds components ("~£2K carry forward combined with ~£7K
  ...
  Co 90900 point ~40 words.
- *After:* `"Co 90050's ~£9K out-of-balance is driven by transactions; the
  Accountant should likely clear or journal it this period."` (18 words) + one
  13-word Co 90900 point, no service line, no arithmetic.

**Apr 30, 2016 (worst verbosity)**
- *Before:* a single 60-word point tracing the $740 carry forward + a service line.
- *After:* `"Co 90900 carry forward of ~$740 originated in the Apr 2 period from
